   ...
   var Income = function(id, description, value) {
    ...
    return {
        ...
        deleteItem: function (type, id) {
            ...
            if (index !== -1){
                data.allItems[type].splice(index, 1); // Removes elements at a starting index
            }
    ...
    return {
        getInput: function() {
            return {
                ...
                value: parseFloat(document.querySelector(DOMstrings.inputValue).value) // Makes a float to be able to calculate
            };
        },
        ...
        displayPercentages: function(percentages) {
            var fields = document.querySelectorAll(DOMstrings.expensesPercLabel); // Node list (can't foreach)
